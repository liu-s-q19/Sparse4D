...
def parse_args():
    ...
    parser.add_argument("--config", default='projects/configs/sparse4dv3_temporal_r50_1x8_bs6_256x704.py', help="train config file path")
    parser.add_argument("--work-dir", default='work_dirs/sparse4dv3_temporal_r50_1x8_bs6_256x704', help="the dir to save logs and models")
    parser.add_argument(
